// Simple test script to verify teacher schedule update functionality

async function testTeacherScheduleUpdate() {
  try {
    console.log('Testing teacher schedule update API...');
