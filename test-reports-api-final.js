// Test the final fixed reports API approach
  ...
  try {
    ...
    const docDefinition = {
      content: [
        ...
        { text: '\n' },
        { text: 'This is a test PDF generated using the final fixed approach with standard fonts.', font: 'Helvetica' }
      ],
      styles: {
        header: {
          fontSize: 18,
    ...
    pdfDoc.on('end', () => {
      ...
      console.log('PDF generated successfully using final fixed approach. Size:', result.length, 'bytes');
    });
