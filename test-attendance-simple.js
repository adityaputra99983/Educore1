/**
 * Simple test script to verify attendance tracking functionality
 */

const { MongoClient } = require('mongodb');

// Hardcoded MongoDB URI from .env.local
const uri = "mongodb+srv://noahdb:NoahSchool2024@cluster0.ndikkxq.mongodb.net/noahdb?retryWrites=true&w=majority&appName=Cluster0";
