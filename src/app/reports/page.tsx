...
export default function ReportsPage() {
  ...
  return (
    <div className={`min-h-screen p-6 no-print ${settings.theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-7xl mx-auto">
        {/* Add report-container class for print styling */}
        <div className="report-container">
          ...
          {/* Filter Section with Enhanced Design - Add no-print to hide during print */}
          <div className={`rounded-2xl p-6 mb-6 shadow-lg transition-all duration-300 no-print ${settings.theme === 'dark' ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-100'
            }`}>
          ...
          {/* Export Buttons - Add no-print to hide during print */}
          {reportData && (
            <div className={`rounded-2xl p-6 mb-6 shadow-lg transition-all duration-300 no-print ${settings.theme === 'dark' ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-100'
              }`}>
          ...
          {/* Report Content - This will be visible during print */}
          {loading ? (
